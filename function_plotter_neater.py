...
fig.legend(leg_handles, leg_labels, loc='upper center', ncol=4, fontsize=10,
...
leg_handles.append(Line2D([], [], color=cm(0), marker='o', linestyle='-', markersize=5)); leg_labels.append('Sersic')
