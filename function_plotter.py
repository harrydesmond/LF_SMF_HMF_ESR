...
ax_lf_nll.set_xlabel(r'$\log_{10}(L / L_\odot)$', fontsize=12)
ax_smf_nll.set_xlabel(r'$\log_{10}(M_\star / M_\odot)$', fontsize=12)
...
ax_nll.set_xlabel(r'$\log_{10}(M_{\rm halo} / h^{-1} M_\odot)$', fontsize=16)
